 ...
 */
export declare function isDesktopUnderlay(label?: string): Promise<boolean>;
/**
 ...
 *  will be used.
 */
export declare function setDesktopUnderlay(desktopUnderlay: boolean, label?: string): Promise<void>;
/**
 ...
 */
export declare function toggleDesktopUnderlay(label?: string): Promise<boolean>;
